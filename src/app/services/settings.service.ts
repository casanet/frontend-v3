...
import { IftttIntegrationSettings, ProgressStatus, RemoteConnectionStatus, RemoteSettings, UpdateResults, User, VersionInfo, VersionUpdateStatus } from '../../be-assets/sharedInterfaces';
